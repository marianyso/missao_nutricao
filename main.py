...
def gerar_fase_2():
    ...
    for _ in range(12):
        lista.append(Alimento("bom", random.randint(60, LARGURA - 60), random.randint(-400, -110)))
    # 3 alimentos ruins (vermelhos)
    for _ in range(6):
        lista.append(Alimento("ruim", random.randint(60, LARGURA - 60), random.randint(-300, -50)))
    return lista
